...
public class ConnectionUtil {
	...
	// add your jdbc url
	public static final String URL = "jdbc:oracle:thin:@revassessment.c3ynkxcfuk8l.us-east-2.rds.amazonaws.com:1521:ORCL";
	...
	public static final String TIER_3_SEQUENCE_NAME = "AUTO_ID";
